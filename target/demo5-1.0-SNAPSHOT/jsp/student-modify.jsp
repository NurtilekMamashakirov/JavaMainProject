...
<h2 align="center">Для модифицирования студента отредактируйте все поля и нажмите кнопку "Применить"</h2>
<br>
<form action="/student-modify" method="post">
    <input type="hidden" name="id" value="${student.id}">
<pre align="center">
             Фамилия <input type="text" name="surname" value="${student.surname}"> <br>
                 Имя <input type="text" name="name" value="${student.name}"> <br>
              Группа <input type="text" name="group" value="${student.group}"> <br>

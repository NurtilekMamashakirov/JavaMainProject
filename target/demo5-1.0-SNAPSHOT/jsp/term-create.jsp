...
<br>
<br>
<form style="margin-left: 285px; font-family: cursive;" action="/term-create" method="post">
    <tr style="margin: 10px;"><small>Длительность (в неделях)</small></tr>
    <input style="font-family: cursive; font-size: 11px;" name="duration" type="text" value="24">
